...
# plugin constants
version = "1.0.0"
plugin = "AbsoluteTV_Updater-" + version
...
if (__name__ == "__main__" ):
    ...
    if dialog.yesno(plugin,"Would you like %s to "%plugin," reset your addons selections and XBMC settings? "," "):
        ...
        #fileurl = "https://app.box.com/s/iilyo9jvt9l2fjwai02m"
        #fileurl = "https://drive.google.com/file/d/0B-YFrZnoboHpNXFmbFNxVlhnZUk/view?usp=sharing"
        #fileurl = "https://docs.google.com/uc?export=download&id=0B-YFrZnoboHpNXFmbFNxVlhnZUk"
        fileurl = "https://drive.google.com/file/d/0B-YFrZnoboHpd3dLenFNN016Mkk/view?usp=sharing"

        fileurl = "https://docs.google.com/uc?export=download&id="+re.search('https://drive.google.com/file/d/(.*)/', fileurl).group(1)
        log("URL :"+fileurl);

        tempfile = os.path.join(xbmc.translatePath("special://temp"),"teste.zip")
        ...
        os.renames(os.path.join(profile,"addon_data1",settings.getAddonInfo('id')),os.path.join(profile,"addon_data",settings.getAddonInfo('id')))
